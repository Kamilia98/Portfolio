 ...
 * Update this file to modify portfolio content without changing HTML/CSS
 */
...
const portfolioData = {
  ...
  personal: {
    ...
    degree: "Excellent",
    grade: "92.47%",
    cvFile: "./kamilia-ahmed-hamed.pdf",
  },
  ...
  socialMedia: [
    {
      name: "LinkedIn",
      url: "https://www.linkedin.com/in/kamiliaahmed/",
      icon: "fab fa-linkedin-in",
      ariaLabel: "LinkedIn",
    },
    {
      name: "Github",
      url: "https://github.com/Kamilia98",
      icon: "fab fa-github",
      ariaLabel: "Github",
    },
    {
      name: "Hackerrank",
      url: "https://www.hackerrank.com/profile/kamiliaahmed01",
      icon: "fab fa-hackerrank",
      ariaLabel: "Hackerrank",
    },
    {
      name: "Codewars",
      url: "https://www.codewars.com/users/Kamilia98",
      icon: "custom-svg",
      ariaLabel: "Codewars",
      customSvg: `<svg fill="#4c2514" width="24px" height="24px" viewBox="0 0 24 24" role="img" xmlns="http://www.w3.org/2000/svg" class="social-media-icon">
    ...
    },
    {
      ...
      url: "https://www.frontendmentor.io/profile/Kamilia98",
      icon: "custom-svg",
  ...
  skills: [
    {
      ...
      subcategories: [
        ...
        {
          name: "Databases",
          skills: ["SQL", "MySQL", "MSSQL", "MongoDB"],
        },
      ],
    },
    {
    ...
    },
    {
      ...
      skills: ["Figma", "Adobe XD", "Wireframing", "Prototyping", "User Flow"],
    },
    {
  ...
  projects: [
    {
      ...
      image: "./images/OncologyManagementSystem.jpg",
      url: "https://github.com/m-emadeddin/chemotherapy-management-system",
      category: "web",
      visible: true,
    },
    {
      title: "Furniture ecommerce",
      image: "./images/FurniroEcommerce.png",
      url: "https://furniture-ecommerce-frontend.vercel.app/",
      category: "web",
      visible: true,
    },
    {
      title: "Gamegrow Email template",
      image: "./images/GamegrowEmailTemplate.jpg",
      url: "https://github.com/Kamilia98/Gamegrow-Email-template",
      category: "web",
      visible: true,
    },
    {
      title: "Megaboost Email templates",
      image: "./images/MegaBoost-Booster-New-Boost-Order-Available.png",
      url: "https://github.com/Kamilia98/Megaboost-Email-templates",
      category: "web",
      visible: true,
    },
  ],
  ...
  testimonials: [
    {
      content:
        "Kamilia exceeded all expectations with her impeccable attention to detail, bug-free code, and sheer PROFESSIONALISM 👍. Collaboration was smooth and effortless; she was polite and highly cooperative. She even provided invaluable design tips and tricks—definitely working with her again! Everything went as planned, and she delivered ahead of schedule.",
    },
    {
      content:
        "Kamilia was very helpful and professional. She worked with me on what I wanted creating and made good suggestions of edits that improved the final email from what I originally had in mind. And it was delivered early. Highly recommended!",
    },
  ],
